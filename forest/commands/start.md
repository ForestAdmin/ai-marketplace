...
5. End on the milestone menu (core) or the concise summary (after deploy). The link to give the user is always the **back-office** `https://app.forestadmin.com/<project>` — never the localhost/hosting agent-backend URL.
